...
function AssistantIdentity({ label = "AI Assistant" }: { label?: string }) {
  return (
    <MessageHeader>
      <span>{label}</span>
      <span>Now</span>
          ...
          <MessageGroup spacing="default">
            ...
            <Message from="assistant">
              ...
              <MessageContent className="gap-3">
                <MessageHeader><span>AI Assistant</span><span>10:24</span></MessageHeader>
                <AgentActivity
                  status="complete"
                  duration={6}
                  defaultOpen
                  ...
                  items={[
                    ...
                    { id: "search", type: "search", query: "order validation failures", results: [
                      { id: "result-1", title: "Agent interface guide", domain: "example.com", url: "/docs/ai-agents" },
                    ] },
                  ]}
                />
            ...
            {messages.map((message) => (
              <Message key={message.id} from={message.from} animateIn>
                ...
                <MessageContent>
                  {message.from === "assistant" ? <AssistantIdentity label="AI Assistant" /> : null}
