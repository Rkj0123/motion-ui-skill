...
export type FolderTabCardProps = Readonly<
  {
    appName?: string;
    cardLabel?: string;
    title?: string;
...
export const FolderTabCard = forwardRef<
  HTMLDivElement,
  FolderTabCardProps
...
FolderTabCard.displayName = "FolderTabCard";
