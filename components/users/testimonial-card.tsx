...
const defaultTestimonials: TestimonialItem[] = [
  {
    quote: "The way each component feels cohesive without being overly uniform is genuinely impressive.",
    name: "Alex Morgan",
  ...
  {
    quote: "The attention to detail in each component really shows, especially spacing and typography.",
    name: "Sarah Chen",
  ...
  {
    quote: "Clean code, zero bloat, and works seamlessly out of the box with Tailwind CSS.",
    name: "David Kim",
    role: "Tech Lead",
    rating: 5,
    avatar: "/profile-picture.png",
