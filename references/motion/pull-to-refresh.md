...
description: "Native-feeling pull-to-refresh container with drag resistance, threshold feedback and async refresh handling."
category: "Components"
publishedAt: "2026-07-17"
updatedAt: "2026-07-17"
documentation: "references/motion/pull-to-refresh.md"
markdown: "references/motion/pull-to-refresh.md"
license: "MIT"
---
...
python scripts/install-component.py pull-to-refresh --dest ./src
```
...
| --- | --- | --- | --- | --- |
| `onRefresh` | `() => void \| Promise<void>` | — | Yes | Runs after the user pulls beyond the threshold and releases. |
| `refreshing` | `boolean` | `false` | No | Keeps the indicator active while an externally managed refresh runs. |
| `disabled` | `boolean` | `false` | No | — |
| `threshold` | `number` | `76` | No | Resisted pull distance in pixels required to refresh. |
| `maxPull` | `number` | `132` | No | Maximum resisted pull distance in pixels. |
| `holdDistance` | `number` | `68` | No | Content offset in pixels while refreshing. |
| `pullingLabel` | `ReactNode` | `Pull to refresh` | No | — |
| `releaseLabel` | `ReactNode` | `Release to refresh` | No | — |
| `refreshingLabel` | `ReactNode` | `Refreshing` | No | — |
| `ariaLabel` | `string` | `Refreshable content` | No | — |
| `className` | `string` | — | No | — |
