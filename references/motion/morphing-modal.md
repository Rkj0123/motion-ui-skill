...
documentation: "references/motion/morphing-modal.md"
markdown: "references/motion/morphing-modal.md"
license: "MIT"
---
...
python scripts/install-component.py morphing-modal --dest ./src
```
...
| --- | --- | --- | --- | --- |
| `viewId` | `string \| null` | — | Yes | Which view is currently shown. `null` closes the modal. |
| `onClose` | `() => void` | — | Yes | — |
