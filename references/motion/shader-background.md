...
description: "Canvas shader backgrounds (mesh gradient, grain, warp, waves, voronoi, dot orbit and more) with a single typed variant prop. Reduced-motion freezes animated variants."
category: "Components"
publishedAt: "2026-07-02"
updatedAt: "2026-07-13"
documentation: "references/motion/shader-background.md"
markdown: "references/motion/shader-background.md"
license: "MIT"
---
...
python scripts/install-component.py shader-background --dest ./src
```
