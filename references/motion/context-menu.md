---
title: "Animated Context Menu"
description: "Composable context-menu primitives with a pointer-origin clip morph, a gliding active row, checkbox and radio choices, keyboard navigation, typeahead, and long-press support."
category: "Components"
publishedAt: "2026-07-27"
updatedAt: "2026-07-27"
documentation: "references/motion/context-menu.md"
markdown: "references/motion/context-menu.md"
license: "MIT"
---
...
python scripts/install-component.py context-menu --dest ./src
```
...
| --- | --- | --- | --- | --- |
| `className` | `string` | — | No | — |
| `ariaLabel` | `string` | `Context menu` | No | — |
