...
description: "A composable application sidebar with morphing nested navigation that folds into an animated icon rail on desktop and becomes a focus-managed sheet on mobile."
category: "Components"
publishedAt: "2026-07-29"
updatedAt: "2026-08-20"
documentation: "references/motion/animated-sidebar.md"
markdown: "references/motion/animated-sidebar.md"
license: "MIT"
---
...
python scripts/install-component.py animated-sidebar --dest ./src
```
...
| `defaultOpenMobile` | `boolean` | `false` | No | — |
...
| --- | --- | --- | --- | --- |
| `className` | `string` | — | No | — |
| `side` | `"left" \| "right"` | `left` | No | — |
| `variant` | `"inset" \| "sidebar" \| "floating"` | `sidebar` | No | — |
| `collapsible` | `"none" \| "offcanvas" \| "icon"` | `icon` | No | — |
| `ariaLabel` | `string` | `Sidebar` | No | — |
