...
documentation: "references/agents/prompt-input.md"
markdown: "references/agents/prompt-input.md"
license: "MIT"
---
...
python scripts/install-component.py prompt-input --dest ./src
```
...
| `models` | `PromptModel[]` | `[]` | No | — |
| `model` | `string` | — | No | — |
| `defaultModel` | `string` | — | No | — |
| `onModelChange` | `((model: string) => void)` | — | No | — |
| `actions` | `PromptAction[]` | `[]` | No | — |
| `onAction` | `((action: string) => void)` | — | No | — |
| `onSubmit` | `((value: string, model?: string) => void \| Promise<void>)` | — | No | — |
| `loading` | `boolean` | `false` | No | — |
| `onStop` | `(() => void)` | — | No | — |
| `minRows` | `number` | `2` | No | — |
| `maxRows` | `number` | `8` | No | — |
| `leadingAction` | `ReactNode` | — | No | — |
| `className` | `string` | — | No | — |
