...
description: "A stable generated-image surface that moves from queued work through progressive refinement to a completed result without layout shift."
category: "AI Agents"
publishedAt: "2026-08-02"
updatedAt: "2026-08-02"
documentation: "references/agents/image-generation.md"
markdown: "references/agents/image-generation.md"
license: "MIT"
---
...
python scripts/install-component.py image-generation --dest ./src
```
...
| --- | --- | --- | --- | --- |
| `children` | `ReactNode` | — | No | The completed media. Pass an img, Next Image, canvas, video, or custom preview. |
| `status` | `"error" \| "complete" \| "queued" \| "generating" \| "refining"` | `generating` | No | — |
| `label` | `string` | — | No | Accessible description. Defaults to a description derived from prompt. |
| `prompt` | `string` | — | No | — |
| `resolution` | `string` | `1024 × 1024` | No | — |
| `aspectRatio` | `AspectRatio` | `1 / 1` | No | CSS aspect ratio reserved before generated media is available. |
| `size` | `"compact" \| "fluid"` | `compact` | No | — |
| `interactive` | `boolean` | `true` | No | Lets the active dither cluster follow fine-pointer movement. |
| `statusText` | `string` | — | No | — |
| `showStatus` | `boolean` | `true` | No | — |
| `onRetry` | `(() => void)` | — | No | — |
| `className` | `string` | — | No | — |
| `mediaClassName` | `string` | — | No | — |
| `statusClassName` | `string` | — | No | — |
