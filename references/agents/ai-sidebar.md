---
title: "AI Sidebar"
description: "A collapsible AI workspace sidebar for folders, projects, files, and bookmarks with keyboard navigation, optimistic moves, inline rename, and overflow-aware labels."
category: "AI Agents"
publishedAt: "2026-08-02"
updatedAt: "2026-08-22"
documentation: "references/agents/ai-sidebar.md"
markdown: "references/agents/ai-sidebar.md"
license: "MIT"
---
...
python scripts/install-component.py ai-sidebar --dest ./src
```
...
| --- | --- | --- | --- | --- |
| `items` | `SidebarResource[]` | — | No | — |
| `defaultItems` | `SidebarResource[]` | `[]` | No | — |
| `onItemsChange` | `((items: SidebarResource[]) => void)` | — | No | — |
| `onMove` | `((move: SidebarResourceMove) => void \| Promise<void>)` | — | No | Reject the promise to roll the optimistic move back. |
| `onMoveError` | `((error: unknown, move: SidebarResourceMove) => void)` | — | No | — |
| `onRename` | `((item: SidebarResource, label: string) => void \| Promise<void>)` | — | No | — |
| `activeId` | `string \| null` | — | No | — |
