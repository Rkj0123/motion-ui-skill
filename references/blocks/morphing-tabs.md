...
documentation: "references/blocks/morphing-tabs.md"
markdown: "references/blocks/morphing-tabs.md"
license: "MIT"
---
...
python scripts/install-component.py morphing-tabs --dest ./src
```
...
| --- | --- | --- | --- | --- |
| `items` | `MorphingTabsItem[]` | — | Yes | — |
| `value` | `string \| null` | — | No | — |
| `defaultValue` | `string \| null` | — | No | — |
| `onValueChange` | `((id: string \| null) => void)` | — | No | — |
| `onOrderChange` | `((ids: string[]) => void)` | — | No | Called once after a pointer drag or keyboard reorder completes. |
| `onClose` | `((id: string) => void)` | — | No | Enables the close affordance on every tab when provided. |
| `ariaLabel` | `string` | `Tabs` | No | — |
| `className` | `string` | — | No | — |
