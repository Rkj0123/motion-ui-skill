...
documentation: "references/blocks/notification-stack.md"
markdown: "references/blocks/notification-stack.md"
license: "MIT"
---
...
python scripts/install-component.py notification-stack --dest ./src
```
