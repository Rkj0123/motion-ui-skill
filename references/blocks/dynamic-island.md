...
documentation: "references/blocks/dynamic-island.md"
markdown: "references/blocks/dynamic-island.md"
license: "MIT"
---
...
python scripts/install-component.py dynamic-island --dest ./src
```
...
| --- | --- | --- | --- | --- |
| `view` | `string \| null` | — | Yes | Active view id. `null` shows the compact pill. |
| `compact` | `ReactNode` | — | No | Compact pill content, shown when no view is active. |
| `children` | `ReactNode` | — | No | DynamicIslandView elements. |
| `className` | `string` | — | No | — |
...
| Prop | Type | Default | Required | Description |
| --- | --- | --- | --- | --- |
| `id` | `string` | — | Yes | Matches the parent `view` prop when active. |
| `className` | `string` | — | No | — |
