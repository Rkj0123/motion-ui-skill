...
documentation: "references/blocks/expandable-tabs.md"
markdown: "references/blocks/expandable-tabs.md"
license: "MIT"
---
...
python scripts/install-component.py expandable-tabs --dest ./src
```
...
| --- | --- | --- | --- | --- |
| `items` | `ExpandableTabsItem[]` | — | Yes | — |
| `value` | `string \| null` | — | No | Active tab id, or null/undefined for the closed (bar-only) state. |
| `defaultValue` | `string \| null` | `null` | No | — |
| `onValueChange` | `((id: string \| null) => void)` | — | No | — |
| `className` | `string` | — | No | — |
| `classNames` | `ExpandableTabsClassNames` | — | No | — |
