...
documentation: "references/blocks/swipeable-list.md"
markdown: "references/blocks/swipeable-list.md"
license: "MIT"
---
...
python scripts/install-component.py swipeable-list --dest ./src
```
...
| --- | --- | --- | --- | --- |
| `items` | `SwipeableListItem[]` | — | Yes | — |
| `value` | `SwipeableListValue \| null` | — | No | — |
| `defaultValue` | `SwipeableListValue \| null` | `null` | No | — |
| `onValueChange` | `((value: SwipeableListValue \| null) => void)` | — | No | — |
| `onAction` | `((payload: { item: SwipeableListItem; action: SwipeAction; side: SwipeSide; }) => void)` | — | No | — |
| `actionWidth` | `number` | `56` | No | — |
| `revealThreshold` | `number` | `34` | No | — |
