...
The checks cover the 130-component catalog, referenced files, installer safety, generated docs, dependency coverage, and the source-reference exclusion rule.
